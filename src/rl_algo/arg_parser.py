...
def parse():
    ...
    parser.add_argument('-ec', '--exp_count', type=int, nargs='?', default=20 ,help='an integer showing experiment number')
    parser.add_argument('-e', '--episode', type=int, nargs='?', default=1200 ,help='an integer for the Episode')
    parser.add_argument('-s', '--steps', type=int, nargs='?', default=100 ,help='an integer for the steps')
    ...
    parser.add_argument('-re', '--render', type=bool, nargs='?', default=True, help='a bool for the render parameter')
    parser.add_argument('-ld', '--load', type=bool, nargs='?', default=True, help='a bool for the render parameter')
